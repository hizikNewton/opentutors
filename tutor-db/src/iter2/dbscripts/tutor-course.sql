...
drop table if exists ezy_tutor_c4;

/* Create tables. */
create table ezy_tutor_c4(
...
REFERENCES ezy_tutor_c4(tutor_id)
ON DELETE cascade
);

grant all privileges on table ezy_tutor_c4 to truuser;
grant all privileges on table ezy_course_c4 to truuser;
grant all privileges on all sequences in schema public to truuser;

insert into ezy_tutor_c4(tutor_id, tutor_name, tutor_pic_url,tutor_profile)
